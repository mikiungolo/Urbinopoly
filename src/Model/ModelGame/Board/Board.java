package Model.ModelGame.Board;

import java.util.stream.IntStream;

import Model.ModelGame.Board.Pieces.*;
import Model.ModelGame.Board.Pieces.Deck.ProbabilityDeck;
import Model.ModelGame.Board.Pieces.Deck.UnexpectedDeck;
import Model.ModelGame.Board.Pieces.Property.*;
import Model.ModelGame.Board.Pieces.Taxes.Taxes;

// modellazione del tabellone di gioco tramite design pattern Singleton
// --> Il tabellone è uno ed unico, da cui deriva la scelta del pattern.
public class Board {
    ...
    // Istanza per il pattern Singleton
    ...
    private Board() {
        ...
        squares[2] = new Square.Probability();
        ...
        squares[17] = new Square.Probability();
        ...
        squares[22] = new Square.Unexpected();
        ...
        squares[32] = new Land("Via Accipizza", 300, new int[] { 26, 130, 390, 900, 1100, 1275 },
                Land.ColorUrbinopoly.VERDE, 200);
        squares[33] = new Square.Probability();
        ...
        squares[36] = new Square.Unexpected();
