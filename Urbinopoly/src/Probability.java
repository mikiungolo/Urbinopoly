...
public class Probability extends Cards {
    ...
    public Probability() {
        ...
        // Movimenti
        super.add(new Card(Card.TypeCard.PROBABILITY.name(), Card.TypeCard.PROBABILITY,
                "Ritornate a Piazza Della Repubblica."));
        super.add(new Card(Card.TypeCard.PROBABILITY.name(), Card.TypeCard.PROBABILITY, "Andate fino al via!"));
        // Riscossioni
        super.add(new Card(Card.TypeCard.PROBABILITY.name(), Card.TypeCard.PROBABILITY,
